...
const dropArea = document.querySelector(".arquivos-div");
const fileInput = document.getElementById("arquivo");
const labelArquivo = document.getElementById("label-arquivo");

if (dropArea != undefined && dropArea.style.display == "flex") {
    // Tipos permitidos
...
function validarArquivo(arquivo) {
    ...
    preview.innerHTML = `
        <div class="arquivo-preview">
            ...
            <button type="button" class="remover-arquivo" onclick="removerArquivo()">
