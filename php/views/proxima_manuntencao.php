...
<head>
    ...
    <title>Prox. Manutenção - NR12</title>
    ...
    <section class="sec-main">
        ...
        <div class="page-actions-bar">
            <form action="" method="GET" class="page-search-form">
                ...
                <div class="page-search-box <?php echo $busca_atual ? 'has-content' : ''; ?>">
                    <input type="text" name="search" value="<?php echo htmlspecialchars($busca_atual); ?>" placeholder="Pesquisar agendamento...">
                    <?php if ($busca_atual): ?>
            ...
            <button class="btn-page-action" onclick="showModal('adicaoAgendamento')"><i class="bi bi-plus-circle"></i> Agendar Manutenção</button>
        </div>
        ...
        <div class="tabela-bg2">
            ...
            <table class="tabela-main">
                ...
                <tbody id="tabela-agendamento-srv">
                    <?php
                        ...
                        while ($linha = $resultado->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <div style='display: flex; gap: 5px; justify-content: center;'>
                                        <button class='btnAcao editar' type='button' title='Editar' onclick=\"showModal('editarMaquina', " . $linha['idmaquina'] . ")\"><i class='bi bi-pencil-square'></i></button>
                                        <button class='btnAcao deletar' type='button' title='Excluir' onclick=\"showModal('excluirMaquina', " . $linha['idmaquina'] . ",'')\"><i class='bi bi-trash'></i></button>
                                    </div>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='6' style='text-align:center; padding:30px; opacity:0.6;'><i class='bi bi-info-circle' style='font-size:1.5rem; display:block; margin-bottom:10px;'></i>Nenhuma próxima manutenção encontrada.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
