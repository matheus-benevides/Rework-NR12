    ...
    <section class="sec-main">
        ...
        <div class="div-header">
            <div class="div-img-header">
                <h2>Painel de Controle de Cursos</h2>
            </div>
        ...
        <div class="div-btns-pages">
            ...
            <form action="" method="GET" style="display: flex; gap: 10px; align-items: center;">
                <div>
                    ...
                    <div class="filtrar-status">
                        ...
                        <select id="select-filtro-cursos" name="filtro-status" onchange="filtrarCursos()">
            ...
            <button class="btn" onclick="showModal('adicaoCurso')">Adicionar Curso <i
                ...
                <tbody id="tabela-cursos">
                    ...
                    if ($resultado && $resultado->num_rows > 0) {
                        while ($linha = $resultado->fetch_assoc()) {
                            ...
                            if ($status == 'ativo') {
                                echo "<button class='btnAcao deletar' type='button'
                                                onclick=\"showModal('desativarCurso', " . $linha['idcurso'] . ")\">
                                                <i class='bi bi-x-lg'></i>
                                            </button>";
                            } else {
                                echo "<button class='btnAcao confirmar' type='button'
        ...
        <div class="div-btns-change">
            <button id="btn-ant" type="button">
                <i class="bi bi-chevron-left"></i>
            </button>
            <button id="btn-prox" type="button">
