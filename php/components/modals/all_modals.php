...
<div class="modal-fundo" id="alunosLote">
    <div class="modal-box">
        ...
        <form id="form-cad-aluno" class="modal-form">
            ...
            <div class="modal-input" id="preview-arquivo"></div>
            <div class="modal-footer">
...
<div class="modal-fundo" id="erro" style="display: none;">
    <div class="modal-box" id="erro-box">
        <div class="modal-header">
            <h5 id="sucesso-txt">Erro</h5>
            <button style='color: var(--txtClaro); font-size: var(--text-base)' onclick="closeModal('sucesso')"><i
                    class="bi bi-x-lg"></i></button>
        </div>
        <div class="modal-row">
            <p id="erro-msg" style="font-size: var(--text-sm);">A operação de
                <?php echo $_GET['sucesso'] ?? 'sucesso' ?> não pode ser finalizada devido a um erro.
            </p>
        </div>
    </div>
</div>
