...
<nav class="sidebar">
    ...
    <div class="div-configs">
        <div>
            ...
            <!-- DASHBOARD -->
            <a href="suporte.php" class="<?php if ($atualmente_em == 'suporte.php') echo 'ativo'; ?> configs">
                <i class="bi bi-headset"></i>
            </a>

            <!-- DASHBOARD -->
            <a href="perfil.php" class="<?php if ($atualmente_em == 'perfil.php') echo 'ativo'; ?> configs">
